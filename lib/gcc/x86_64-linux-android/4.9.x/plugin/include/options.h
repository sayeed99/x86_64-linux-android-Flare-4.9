...
#endif
#ifdef GENERATOR_FILE
extern int patch_functions_dont_always_patch_main;
#else
  int x_patch_functions_dont_always_patch_main;
#define patch_functions_dont_always_patch_main global_options.x_patch_functions_dont_always_patch_main
#endif
#ifdef GENERATOR_FILE
extern int patch_functions_for_instrumentation;
#else
  int x_patch_functions_for_instrumentation;
#define patch_functions_for_instrumentation global_options.x_patch_functions_for_instrumentation
#endif
#ifdef GENERATOR_FILE
extern int patch_functions_ignore_loops;
#else
  int x_patch_functions_ignore_loops;
#define patch_functions_ignore_loops global_options.x_patch_functions_ignore_loops
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_target_option
{
  ...
  signed char x_patch_functions_dont_always_patch_main;
  signed char x_patch_functions_for_instrumentation;
  signed char x_patch_functions_ignore_loops;
};
...
enum opt_code
{
  ...
  /* OPT_mfused_madd = 1175, */              /* -mfused-madd */
  OPT_mfxsr = 1176,                          /* -mfxsr */
  OPT_mglibc = 1177,                         /* -mglibc */
  OPT_mhard_float = 1178,                    /* -mhard-float */
  OPT_mhle = 1179,                           /* -mhle */
  OPT_mieee_fp = 1180,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1181,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1182,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1183,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1184, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1185,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1186,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1187,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1188,                /* -mlong-double-80 */
  OPT_mlwp = 1189,                           /* -mlwp */
  OPT_mlzcnt = 1190,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1191,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1192,              /* -mmemset-strategy= */
  OPT_mmmx = 1193,                           /* -mmmx */
  OPT_mmovbe = 1194,                         /* -mmovbe */
  OPT_mms_bitfields = 1195,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1196,            /* -mno-align-stringops */
  OPT_mno_default = 1197,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1198,             /* -mno-fancy-math-387 */
  OPT_mno_patch_functions_main_always = 1199,/* -mno-patch-functions-main-always */
  OPT_mno_push_args = 1200,                  /* -mno-push-args */
  OPT_mno_red_zone = 1201,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1202,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1203,       /* -momit-leaf-frame-pointer */
  OPT_mpatch_functions_for_instrumentation = 1204,/* -mpatch-functions-for-instrumentation */
  OPT_mpatch_functions_ignore_loops = 1205,  /* -mpatch-functions-ignore-loops */
